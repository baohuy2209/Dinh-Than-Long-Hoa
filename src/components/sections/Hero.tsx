  ...
  return (
    <div className="relative w-full h-screen flex flex-col justify-between overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center text-center pt-[82px] px-5 w-full">
        <h1 className="font-['Lexend'] text-[66px] font-bold text-white leading-[74px] max-w-[1500px] mb-3.5 max-md:text-5xl max-md:leading-[56px] max-sm:text-4xl max-sm:leading-[44px]">
          Khám Phá Đình Long Hòa – Di Tích Văn Hóa Giữa Lòng Thành Phố
        </h1>
        <p className="font-['DM_Sans'] text-[30px] font-light text-white leading-[40px] tracking-[1%] max-w-[1245px] mb-[58px] max-md:text-2xl max-md:leading-8 max-sm:text-lg max-sm:leading-7">
